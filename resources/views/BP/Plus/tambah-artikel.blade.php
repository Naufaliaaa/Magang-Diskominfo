...
<body class="bg-gray-100">
    <div class="flex min-h-screen">
        ...
        <main class="flex-1 p-6">
            <h1 class="text-2xl font-bold text-blue-800 mb-6">Tambah Artikel Baru</h1>

            <form id="formArtikel" onsubmit="event.preventDefault(); konfirmasiRilis();" enctype="multipart/form-data">
                <!-- Judul -->
                <div class="mb-4">
                ...
                <!-- Gambar -->
                <div class="mb-6">
                    <label for="gambar" class="block text-gray-700 font-semibold mb-2">Upload Gambar Artikel</label>
